...
public class AddNewCardFragmentDialog extends DialogFragment {
    ...
    public AddNewCardFragmentDialog() {
        super(R.layout.dialog_fragment_add_new_card);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        card_save = view.findViewById(R.id.update_updatecard_dialog);
